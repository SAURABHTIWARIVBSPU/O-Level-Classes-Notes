    ...
    <div className="space-y-10 py-4 max-w-7xl mx-auto">
      ...
      <div className="space-y-4 border-b border-slate-200 dark:border-slate-800 pb-8">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 font-mono text-xs font-bold">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {cccChaptersData.map((ch) => {
          ...
          return (
            <div
              key={ch.slug}
              className="p-6 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-emerald-500 transition-all flex flex-col justify-between space-y-4 shadow-xs group"
            >
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
                <Link
                  ...
                  className="w-full py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 group-hover:bg-emerald-600 group-hover:text-white text-slate-800 dark:text-slate-200 text-xs font-bold transition-all flex items-center justify-center gap-1.5"
                >
